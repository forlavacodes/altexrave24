...
function setupFormToggle() {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    passwordToggle.addEventListener("click", function () {
      ...
      passwordIcon.classList.toggle("la-eye", !isPasswordVisible);
      passwordIcon.classList.toggle("la-eye-slash", isPasswordVisible);
    });
  });
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const signUpBtn = document.querySelector('.btn[data-btn="sign-up"]');
    ...
    if (userEmail) {
      ...
      bottomDiv.removeChild(signUpBtn);
    }
  });
  ...
  function checkEmailExists() {
    ...
    fetch(`http://localhost/altexraveregistrationform/api/search-user.php?email=${encodeURIComponent(email)}`
  )
      .then((response) => {
        if (!response.ok) {
  ...
  function sendData() {
    ...
    fetch("http://localhost/altexraveregistrationform/api/add-user.php", {
      method: "post",
      body: formData,
    })
      .then((response) => {
  ...
  function loginData() {
    ...
    fetch("http://localhost/altexraveregistrationform/api/login.php", {
      method: "post",
      body: formData,
    })
      .then((response) => {
